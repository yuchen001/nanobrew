...
- **Seeded upstream coverage** — embedded registry now includes 20 formulae (`gh`, `uv`, `mise`, `ripgrep`, `just`, `lazygit`, `atuin`, `actionlint`, `podman`, `fd`, `bat`, `chezmoi`, `fastfetch`, `git-delta`, `git-lfs`, `golangci-lint`, `k9s`, `llmfit`, `ruff`, `zoxide`) and 46 casks (`1password`, `1password-cli`, `actual`, `alacritty`, `alt-tab`, `android-studio`, `antigravity`, `betterdisplay`, `bitwarden`, `brave-browser`, `bruno`, `cc-switch`, `chatgpt`, `claude`, `cmux`, `codex-app`, `copilot-cli`, `cursor`, `dbeaver-community`, `discord`, `dockdoor`, `firefox`, `ghostty`, `github`, `google-chrome`, `hammerspoon`, `iina`, `iterm2`, `libreoffice`, `linearmouse`, `lm-studio`, `maccy`, `ngrok`, `notion`, `obsidian`, `ollama-app`, `openclaw`, `opencode-desktop`, `rectangle`, `slack`, `stats`, `sublime-text`, `telegram`, `utm`, `vlc`, `zed`).
- **Programmatic upstream seeding tools** — added seeders for popular formulae and casks using Homebrew analytics, GitHub release assets, pinned vendor URLs, checksums, platform matching, binary-only cask handling, cask binary target preservation, and artifact inference.
...
- **Top-100 upstream gap report** — added `scripts/upstream-gap-report.mjs` to classify every unseeded top-N formula and cask by Homebrew rank, install count, current seeder skip bucket, artifact/source shape, likely resolver class, and checksum availability. The current top-100 coverage is 11/100 formulae and 44/100 casks covered; the report classifies the remaining 89 formula gaps and 56 cask gaps so resolver work can be prioritized from data instead of ad hoc inspection.
...
### Coverage Planning
- **Top-100 cask coverage improved** — generated cask expansion moves casks from the original 18/100 baseline to 44/100 covered and 613,934 / 1,611,605 top-100 30-day installs (38.09%). Formula coverage remains 11/100 at 838,745 / 5,135,645 (16.33%).
...
- **Cask gap buckets** — the remaining 56 unseeded top-100 casks classify as 14 `package_manager_cli`, 9 `app_cask`, 16 `github_release_asset`, 8 `tap_cask`, and 9 `pkg_cask` candidates.
