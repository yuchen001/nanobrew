...
- **Seeded upstream coverage** — embedded registry now includes 251 formula records (20 GitHub Release binary/source records plus 231 generated Homebrew bottle locks) and 50 cask records. The formula bottle lock batch covers `node`, `awscli`, `ffmpeg`, `git`, `cmake`, `go`, `coreutils`, `jq`, `python@3.14`, `openssl@3`, `docker`, `kubernetes-cli`, `gcc`, `helm`, `llvm`, `rust`, `php`, `curl`, `deno`, `hugo`, and their generated Homebrew bottle dependency closure.
...
### Coverage Planning
- **Top-100 formula coverage improved** — generated Homebrew bottle locks move formulae from 11/100 covered to 95/100 covered and 4,937,354 / 5,131,605 top-100 30-day installs (96.22%). The generated formula registry also has zero missing dependencies across its seeded formula graph. Casks remain 48/100 covered and 836,995 / 1,610,712 top-100 30-day installs (51.96%).
